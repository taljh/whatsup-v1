      ...
      <div className="space-y-8">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-50 rounded-xl p-6 space-y-4">
            ...
            <p className="text-sm text-gray-500">سيتم إرسال هذه الرسالة فورا للعملاء الذين قاموا بترك السلات</p>
            {/* Template Selector */}
            <div className="relative">
              <select className="appearance-none w-full border border-gray-200 rounded-xl py-3 px-4 text-gray-700 focus:outline-none focus:border-blue-500 bg-white shadow-sm">
